...
_reloaders: Dict[str, Any] = {}  # ProxyModule:Reloader
...
if test_version:
    ...
    use_mod: ModuleType
    use_mod = Use() # type:ignore
    sys.modules["use"] = use_mod
use_mod.Version = Version # type:ignore
use_mod.mode = mode # type:ignore
use_mod
